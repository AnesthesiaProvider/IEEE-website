    ...
    <html>
      <head>
        ...
        <style>
          ...
          .detail-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #231B32; font-size: 14px; }
          .detail-row:last-child { border-bottom: none; }
          .label { color: #CAC4D1; font-weight: 500; }
          .value { color: #FAF8FD; font-weight: 600; }
          .footer { font-size: 12px; color: #797380; text-align: center; margin-top: 32px; border-top: 1px solid #231B32; padding-top: 16px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="details-card">
            ...
            <div class="detail-row">
              ...
              <span class="value" style="color: #876DBF;">${app.domain}</span>
            </div>
            <div class="detail-row">
